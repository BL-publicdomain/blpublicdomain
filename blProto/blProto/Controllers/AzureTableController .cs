...
namespace RazorTesting.Controllers
{
    public class AzureTableController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var classController = new AzureTableController();

            classController.connectionDatabaseForAzureTableStorage(out mainbl, out placebl, out publisherbl, out titlebl);

         
            String keyword = "Manchester";


            queryForPlace_Simple(placebl, ref results, keyword);


            search_MainTable(mainbl, ref results, keyword);
        ...
        public void connectionDatabaseForAzureTableStorage(out CloudTable mainbl, out CloudTable placebl, out CloudTable publisherbl, out CloudTable titlebl)
        {
            ...
            connectionAzureTables(client, out mainbl, out placebl, out publisherbl, out titlebl);
        ...
        public void connectionAzureTables(CloudTableClient client, out CloudTable mainbl, out  CloudTable placebl, out CloudTable publisherbl, out CloudTable titlebl)
        {
        ...
        public void queryForPlace_Simple(CloudTable placebl, ref List<TableKeys> results, string keyword)
        {
       ...
       new TableQuery<BookEntity>()
          .Where(TableQuery.GenerateFilterCondition("PartitionKey",
            ...
            foreach (var v in listOfPlaces)
            {
                ...
                if (ocr != "")
                {
                    ...
                    frequentWordOCR(ocr, keyword, out counterOCR);
                    if (counterOCR != 0)
                    {
        ...
        public void search_MainTable(CloudTable mainbl, ref List<TableKeys> results, string keyword)
        {
        ...
        public void frequentWordOCR(String filename, string keyword, out int counter)
        {
